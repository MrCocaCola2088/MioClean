...
- Name: tests\ia-pedidos.spec.ts >> MioClean IA pedidos flow >> POST /api/ai/parse-text returns AI-matched products for a valid shopping request
- Location: tests\ia-pedidos.spec.ts:8:7
