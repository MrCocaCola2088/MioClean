...
- Name: tests\ia-pedidos.spec.ts >> MioClean IA pedidos flow >> POST /api/ai/parse-text can auto-add matched items to a cart session
- Location: tests\ia-pedidos.spec.ts:25:7
